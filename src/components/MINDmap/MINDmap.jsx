...
{/* <div className={css.gridContainer}> */}
          {/* <div className={`${css.containerItem} ${css.slide}`} index="0"
          ...
          <div className={`${css.containerItem} ${css.slide}`}    index="1"         
              isOpen={index === openIndex}
              onItemClick={() => handleItemClick(index)}
              draggable={true}
                onDragStart={(e) => handleDragStart(e, index)}
          ...
          <div className={`${css.containerItem} ${css.slide}`} index="2"
          ...
          <p><a className={`${css.linkMint} ${css.slide}`} href="#hero"    index="3"          
              isOpen={index === openIndex}
              onItemClick={() => handleItemClick(index)}
              draggable={true}
                onDragStart={(e) => handleDragStart(e, index)}
